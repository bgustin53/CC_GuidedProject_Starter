...
{
    [SerializeField] private Transform player;             // The target object to follow
    ...
    private void LateUpdate()
    {
        ...
        Vector3 desiredPosition = player.position + offset.normalized * distance + Vector3.up * height;
    ...
    public void CameraView(float d, float h)
    {
        distance = d;
        height = h;
    }
